    ...
    <div class="ml-auto d-flex">
        ...
        <div>
            <a href="#" data-toggle="dropdown" class="header-icon d-flex align-items-center justify-content-center ml-2">
                <img src="<?php echo e(backendAssets('img/logo.png')); ?>" class="profile-image rounded-circle">
            </a>
            <div class="dropdown-menu dropdown-menu-animated dropdown-lg">
                <div class="dropdown-header bg-trans-gradient d-flex flex-row py-4 rounded-top">
                    <div class="d-flex flex-row align-items-center mt-1 mb-1 color-white">
                        <span class="mr-2">
                            <img src="<?php echo e(backendAssets('img/logo.png')); ?>" class="rounded-circle profile-image">
                        </span>
                        <div class="info-card-text">
                            <div class="fs-lg text-truncate text-truncate-lg">Dadan Hidayat</div>
                ...
                <a href="<?php echo e(base_url(route_to('backend_akun_setting'))); ?>" class="dropdown-item">
                    <span data-i18n="drpdwn.settings">Pengaturan Akun</span>
                </a>
                <div class="dropdown-divider m-0"></div>
...
<!-- END Page Header --><?php /**PATH E:\htdocs\project\brycms\brycms\theme\backend/_section/header.blade.php ENDPATH**/ ?>