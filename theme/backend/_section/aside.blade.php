 ...
 <aside class="page-sidebar list-filter-active">
     <div class="page-logo">
         <a href="web.html" class="page-logo-link press-scale-down d-flex align-items-center position-relative">
             <img src="{{ backendAssets('img/logo.png') }}" style="width:40px!important;" alt="SIM Rembang" aria-roledescription="logo">
     ...
     <nav id="js-primary-nav" class="primary-nav" role="navigation">
         ...
         <ul id="js-nav-menu" class="nav-menu">
             <li>
                 <a href="{{ base_url(route_to('backend_index')) }}" title="Aplikasi Web" data-filter-tags="aplikasiweb" class=" waves-effect waves-themed" aria-expanded="false">
